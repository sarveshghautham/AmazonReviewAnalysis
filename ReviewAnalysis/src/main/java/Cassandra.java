...
public class Cassandra
{
	...
	public void addProduct(String productIdentifier, String productName,
			double posPercentage, String tags)
	{
		// INSERT INTO pds_ks.reviews (product_id, product_name,
		// positive_percentage, top_k_words) VALUES ('B0000AOXLY',' 14k White
		// Gold Freshwater Cultured Pearl 6.0-6.5mm Pendant, 18"
		// ',100.0,'lovely:3||delicate:2||yellow:2||afraid:1||almost:1||also:1||certain:1||certainly:1||classy:1||eventually:1||great:1||little:1||purely:1||quite:1||simple:1||small:1||then:1||too:1||traditional:1||well:1||white:1||')
		Statement statement = QueryBuilder.insertInto(keySpace, tableName)
				.value("PRODUCT_ID", productIdentifier)
				.value("PRODUCT_NAME", productName)
				.value("POSITIVE_PERCENTAGE", posPercentage)
				.value("TOP_K_WORDS", tags);
	...
	public String selectProduct(String productId)
	{
		...
		for (Row row : result)
		{
			...
			results.append(d.toString()).append("->")
	...
	public static void main(String[] args)
	{
		...
		casObj.addProduct("xxx", "yyy", 10, "abc");
		String data = casObj.selectProduct("xxx");
